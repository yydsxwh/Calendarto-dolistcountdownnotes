...
正式包 `versionName` 2.3.1、`versionCode` 14，包名 `com.yydsxwh.kemiao.days`，启动器名「颗秒日事」。Debug 包名带 `.debug`，名称是「颗秒日事调试」，不上传。没有 `website` 构建类型，Release 缺少正式 keystore 环境变量时直接失败。
